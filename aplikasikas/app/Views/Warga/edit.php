...
<div class="container mt-5">
    <div class="row justify-content-md-center">
        <h1 class="my-3 text-center">Formulir Edit Warga</h1>
        <div class="col-8">
            <form action="<?= ('/Warga/update/') . $warga['id']; ?>" method="post">
                <div class="row mb-3">
                    <label for="nik" class="col-sm-2 col-form-label">NIK</label>
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="nik" name="nik" value="<?= $warga['nik']; ?>" autofocus>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <select class="form-select" aria-label="Default select example" name="jkelamin" required>
                            ...
                            <option value="1" <?php if ($warga['jkelamin'] == "L") echo 'selected="selected"'; ?>>Laki-Laki</option>
                            <option value="2" <?php if ($warga['jkelamin'] == "P") echo 'selected="selected"'; ?>>Perempuan</option>
                        </select>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-sm-10">
                        <input type="number" class="form-control" id="status" name="status" value="<?= $warga['status']; ?>" required>
                    </div>
                </div>
